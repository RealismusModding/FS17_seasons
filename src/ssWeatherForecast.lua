...
function ssWeatherForecast:loadMap(name)
    ...
    self.forecastLength = ssWeatherManager.forecastLength
    ...
    self.hud.overlays.weather_snow = Overlay:new("hud_snow", Utils.getFilename("huds/hud_snow.png", ssSeasonsMod.modDir), 0, 0, width, height);
