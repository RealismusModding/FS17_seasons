...
function ssGrowthManager:loadMap(name)
    ...
    if g_currentMission:getIsServer() == true then
       if self:getGrowthData() == false then
        ...
        log("monthAtGrowthTransitionNumber 1: " .. tostring(ssUtil.monthAtGrowthTransitionNumber(1)))
        log("monthAtGrowthTransitionNumber 2: " .. tostring(ssUtil.monthAtGrowthTransitionNumber(2)))
        log("monthAtGrowthTransitionNumber 3: " .. tostring(ssUtil.monthAtGrowthTransitionNumber(3)))
        log("monthAtGrowthTransitionNumber 4: " .. tostring(ssUtil.monthAtGrowthTransitionNumber(4)))
        log("monthAtGrowthTransitionNumber 5: " .. tostring(ssUtil.monthAtGrowthTransitionNumber(5)))
        log("monthAtGrowthTransitionNumber 6: " .. tostring(ssUtil.monthAtGrowthTransitionNumber(6)))
        log("monthAtGrowthTransitionNumber 7: " .. tostring(ssUtil.monthAtGrowthTransitionNumber(7)))
        log("monthAtGrowthTransitionNumber 8: " .. tostring(ssUtil.monthAtGrowthTransitionNumber(8)))
        log("monthAtGrowthTransitionNumber 9: " .. tostring(ssUtil.monthAtGrowthTransitionNumber(9)))
        log("monthAtGrowthTransitionNumber 10: " .. tostring(ssUtil.monthAtGrowthTransitionNumber(10)))
        log("monthAtGrowthTransitionNumber 11: " .. tostring(ssUtil.monthAtGrowthTransitionNumber(11)))
        log("monthAtGrowthTransitionNumber 12: " .. tostring(ssUtil.monthAtGrowthTransitionNumber(12)))
