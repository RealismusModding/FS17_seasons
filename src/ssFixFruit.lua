...
function ssFixFruit:loadMap(name)
    ...
    local ssFixFruitData = {
        {"sugarBeet",   growthStateTime=28, minHarvestingGrowthState=9,  minForageGrowthState=9},
        {"barley",    growthStateTime=22, minHarvestingGrowthState=4,  minForageGrowthState=3},
        {"wheat",    growthStateTime=23, minHarvestingGrowthState=4,  minForageGrowthState=3},
        {"oat",    growthStateTime=28, minHarvestingGrowthState=4,  minForageGrowthState=3},
        {"rye",    growthStateTime=24.5, minHarvestingGrowthState=4,  minForageGrowthState=3},
        {"poppy",    growthStateTime=29, minHarvestingGrowthState=4,  minForageGrowthState=3},
        {"rape",    growthStateTime=28.5, minHarvestingGrowthState=4,  minForageGrowthState=4},
        {"sunflower",   growthStateTime=24, minHarvestingGrowthState=4,  minForageGrowthState=4},
        {"maize",    growthStateTime=30, minHarvestingGrowthState=4,  minForageGrowthState=3},
        {"oilseedRadish",  growthStateTime=36,  minHarvestingGrowthState=2,  minForageGrowthState=2},
        {"poplar",    growthStateTime=72,  minHarvestingGrowthState=4,  minForageGrowthState=4},
        {"grass",    growthStateTime=54,  minHarvestingGrowthState=2,  minForageGrowthState=2},
        {"dryGrass",   growthStateTime=36,  minHarvestingGrowthState=2,  minForageGrowthState=2},
        {"potato",    growthStateTime=26, minHarvestingGrowthState=9,  minForageGrowthState=9},
        {"soybean",   growthStateTime=27, minHarvestingGrowthState=4,  minForageGrowthState=4},
     }
