...
function ssSnow:loadMap(name)
    ...
    TipUtil.registerDensityMapHeightType(FillUtil.FILLTYPE_SNOW, math.rad(35), 0.8, 0.10, 0.10, 1.20, 3, true, modDir .. "resources/snow_diffuse.dds", modDir .. "resources/snow_normal.dds", modDir .. "resources/snowDistance_diffuse.dds");
    print("Debug: " .. FillUtil.FILLTYPE_SNOW );
